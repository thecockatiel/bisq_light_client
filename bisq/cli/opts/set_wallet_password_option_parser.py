...
class SetWalletPasswordOptionParser(SimpleMethodOptionParser):
    ...
    def __init__(self, args: list[str]):
        ...
        self.parser.add_argument(
            f"--{OptLabel.OPT_NEW_WALLET_PASSWORD}",
            help="new bisq wallet password",
            dest=OptLabel.OPT_NEW_WALLET_PASSWORD,
            type=str,
            default="",
        )
    ...
    def get_new_password(self) -> str:
        return self.options.get(OptLabel.OPT_NEW_WALLET_PASSWORD, "")
