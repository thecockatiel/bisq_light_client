...
class FailedTradeTableBuilder(AbstractTradeListBuilder):
    """Builds a Table from a list of grpc_pb2.TradeInfo objects."""

    def __init__(self, protos: "list[grpc_pb2.TradeInfo]"):
        super().__init__(TableType.FAILED_TRADES_TBL, protos)
    ...
    def _populate_columns(self):
        for trade in self.protos:
            ...
            self.col_closing_status.add_row("Failed")
