...
class OfferPayload(OfferPayloadBase):
    ...
    def from_proto(proto: protobuf.OfferPayload) -> 'OfferPayload':
        ...
        return OfferPayload(
            ...
            txFee=proto.tx_fee,
            makerFee=proto.maker_fee,
            isCurrencyForMakerFeeBtc=proto.is_currency_for_maker_fee_btc,
            buyerSecurityDeposit=proto.buyer_security_deposit,
            sellerSecurityDeposit=proto.seller_security_deposit,
            maxTradeLimit=proto.max_trade_limit,
            maxTradePeriod=proto.max_trade_period,
            useAutoClose=proto.use_auto_close,
            useReOpenAfterAutoClose=proto.use_re_open_after_auto_close,
            lowerClosePrice=proto.lower_close_price,
            upperClosePrice=proto.upper_close_price,
            isPrivateOffer=proto.is_private_offer,
