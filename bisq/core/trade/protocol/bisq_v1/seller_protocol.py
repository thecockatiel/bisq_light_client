...
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_broadcast_payout_tx import (
    SellerBroadcastPayoutTx,
)
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_finalizes_delayed_payout_tx import (
    SellerFinalizesDelayedPayoutTx,
)
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_process_counter_currency_transfer_started_message import (
    SellerProcessCounterCurrencyTransferStartedMessage,
)
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_process_delayed_payout_tx_signature_response import (
    SellerProcessDelayedPayoutTxSignatureResponse,
)
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_process_share_buyer_payment_account_message import (
    SellerProcessShareBuyerPaymentAccountMessage,
)
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_publishes_deposit_tx import (
    SellerPublishesDepositTx,
)
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_publishes_trade_statistics import (
    SellerPublishesTradeStatistics,
)
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_send_payout_tx_published_message import (
    SellerSendPayoutTxPublishedMessage,
)
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_sends_deposit_tx_and_delayed_payout_tx_message import (
    SellerSendsDepositTxAndDelayedPayoutTxMessage,
)
from bisq.core.trade.protocol.bisq_v1.tasks.seller.seller_sign_and_finalize_payout_tx import (
...
class SellerProtocol(DisputeProtocol):
    ...
    def on_mailbox_message(self, message: "TradeMessage", peer: "NodeAddress") -> None:
        ...
        if isinstance(message, CounterCurrencyTransferStartedMessage):
            self.handle_counter_currency_transfer_started_message(message, peer)
    ...
    def handle_delayed_payout_tx_signature_request(
        self, message: "DelayedPayoutTxSignatureResponse", peer: "NodeAddress"
    ):
        self.expect(
    ...
    def handle_share_buyer_payment_account_message(
        self, message: "ShareBuyerPaymentAccountMessage", peer: "NodeAddress"
    ):
        self.expect(
            self.add_phases(
    ...
    def handle_counter_currency_transfer_started_message(
        self, message: "CounterCurrencyTransferStartedMessage", peer: "NodeAddress"
    ):
    ...
    def on_payment_received(
        self, result_handler: ResultHandler, error_message_handler: ErrorMessageHandler
    ) -> None:
        ...
        self.expect(
            ...
            lambda: (
                self.trade.state_property.set(
                    TradeState.SELLER_CONFIRMED_IN_UI_FIAT_PAYMENT_RECEIPT
                ),
    ...
    def on_trade_message(self, message: "TradeMessage", peer: "NodeAddress") -> None:
        ...
        if isinstance(message, DelayedPayoutTxSignatureResponse):
            ...
            self.handle_share_buyer_payment_account_message(message, peer)
