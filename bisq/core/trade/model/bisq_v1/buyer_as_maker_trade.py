...
class BuyerAsMakerTrade(BuyerTrade, MakerTrade):
    def __init__(
            self,
            offer: "Offer",
            trade_tx_fee: "Coin",
    ...
    @staticmethod
    def from_proto(buyer_as_maker_proto: protobuf.BuyerAsMakerTrade, btc_wallet_service: "BtcWalletService", core_proto_resolver: "CoreProtoResolver") -> "Tradable":
        trade_proto = buyer_as_maker_proto.trade
