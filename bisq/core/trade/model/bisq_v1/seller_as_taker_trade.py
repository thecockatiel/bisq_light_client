...
class SellerAsTakerTrade(SellerTrade, TakerTrade):
    def __init__(
            self,
            offer: "Offer",
            amount: "Coin",
    ...
    @staticmethod
    def from_proto(seller_as_taker_proto: protobuf.SellerAsTakerTrade, btc_wallet_service: "BtcWalletService", core_proto_resolver: "CoreProtoResolver") -> "Tradable":
        trade_proto = seller_as_taker_proto.trade
