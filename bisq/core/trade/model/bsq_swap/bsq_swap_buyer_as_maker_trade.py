...
class BsqSwapBuyerAsMakerTrade(BsqSwapBuyerTrade, TakerTrade):
    def __init__(self, 
                 offer: 'Offer',
                 amount: 'Coin',
                 take_offer_date: int,
    ...
    def to_proto_message(self):
        return protobuf.Tradable(
            bsq_swap_buyer_as_maker_trade=protobuf.BsqSwapBuyerAsMakerTrade(
                bsq_swap_trade=super().to_proto_message()
            )
        )
    
    @staticmethod
    def from_proto(bsq_swap_trade: protobuf.BsqSwapBuyerAsMakerTrade):
        proto = bsq_swap_trade.bsq_swap_trade
        return BsqSwapBuyerAsMakerTrade(
