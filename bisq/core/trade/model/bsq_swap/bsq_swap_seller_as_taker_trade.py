...
class BsqSwapSellerAsTakerTrade(BsqSwapBuyerTrade, TakerTrade):
    def __init__(self, 
                 offer: 'Offer',
                 amount: 'Coin',
    ...
    def to_proto_message(self):
        return protobuf.Tradable(
            bsq_swap_seller_as_taker_trade=protobuf.BsqSwapSellerAsTakerTrade(
                bsq_swap_trade=super().to_proto_message()
            )
        )
    
    @staticmethod
    def from_proto(bsq_swap_trade: protobuf.BsqSwapSellerAsTakerTrade):
        proto = bsq_swap_trade.bsq_swap_trade
        return BsqSwapSellerAsTakerTrade(
