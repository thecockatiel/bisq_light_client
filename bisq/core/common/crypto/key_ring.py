...
class KeyRing():
    signature_key_pair: tuple[dsa.DSAPrivateKey, dsa.DSAPublicKey]
    encryption_key_pair: tuple[rsa.RSAPrivateKey, rsa.RSAPublicKey]
    ...
    def __init__(self, key_storage: 'KeyStorage'):
        ...
        self.pub_key_ring = PubKeyRing(signature_pub_key=self.signature_key_pair[1], encryption_pub_key=self.encryption_key_pair[1])
