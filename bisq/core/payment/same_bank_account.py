...
class SameBankAccount(CountryBasedPaymentAccount, BankNameRestrictedBankAccount, SameCountryRestrictedBankAccount):
    ...
    @property
    def bank_id(self):
        return cast(SameBankAccountPayload, self.payment_account_payload).bank_id
