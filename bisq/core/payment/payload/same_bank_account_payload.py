...
class SameBankAccountPayload(BankAccountPayload):
    ...
    def to_proto_message(self):
        ...
        builder.country_based_payment_account_payload.bank_account_payload.same_bank_accont_payload.CopyFrom(
            protobuf.SameBankAccountPayload()
        )
        return builder
