...
class PaxumAccountPayload(PaymentAccountPayload):
    ...
    def to_proto_message(self):
        ...
        builder.Paxum_account_payload.CopyFrom(payload)  # weird protobuf names
        return builder

    @staticmethod
    def from_proto(proto: protobuf.PaymentAccountPayload):
        payload = proto.Paxum_account_payload  # weird protobuf names
        return PaxumAccountPayload(
