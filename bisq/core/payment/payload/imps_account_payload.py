...
class ImpsAccountPayload(IfscBasedAccountPayload):
    ...
    def to_proto_message(self):
        ...
        ifsc_based_account_payload_builder.country_based_payment_account_payload.ifsc_based_account_payload.rtgs_account_payload.CopyFrom(
            protobuf.RtgsAccountPayload()
        )
    ...
    def from_proto(proto: protobuf.PaymentAccountPayload):
        ...
        return ImpsAccountPayload(
            ...
            id=proto.id,
            country_code=country_based_payment_account_payload.country_code,
