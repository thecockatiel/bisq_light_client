...
class PerfectMoneyAccountPayload(PaymentAccountPayload):
    ...
    def to_proto_message(self):
        ...
        builder.perfect_money_account_payload.CopyFrom(
            protobuf.PerfectMoneyAccountPayload(
    ...
    def from_proto(proto: protobuf.PaymentAccountPayload):
        payload = proto.perfect_money_account_payload
        return PerfectMoneyAccountPayload(
