...
class CapitualAccountPayload(PaymentAccountPayload):
    ...
    def to_proto_message(self):
        payload = protobuf.CapitualAccountPayload(
            account_nr=self.account_nr,
        )
        builder = self.get_payment_account_payload_builder()
        builder.capitual_account_payload.CopyFrom(payload)
        return builder

    @staticmethod
    def from_proto(proto: protobuf.PaymentAccountPayload):
        payload = proto.capitual_account_payload
        return CapitualAccountPayload(
            payment_method_id=proto.payment_method_id,
            id=proto.id,
            email=payload.account_nr,
    ...
    def get_payment_details(self) -> str:
        ...
        label = Res.get_with_col("payment.capitual.cap")
