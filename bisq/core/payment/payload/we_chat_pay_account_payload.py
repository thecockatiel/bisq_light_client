...
class WeChatPayAccountPayload(PaymentAccountPayload):
    ...
    def to_proto_message(self):
        ...
        builder.we_chat_pay_account_payload.CopyFrom(
            protobuf.WeChatPayAccountPayload(
    ...
    def from_proto(proto: protobuf.PaymentAccountPayload):
        payload = proto.we_chat_pay_account_payload
        return WeChatPayAccountPayload(
